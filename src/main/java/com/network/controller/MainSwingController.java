...
public class MainSwingController {
	...
	public MainSwingController() {
		...
		frame.setSize(new Dimension(1900, 1200));
		...
		bottomPanel.add(consoleScroller);
		JLabel totalTrafficUsedLabel=new JLabel();
		captureProcess = new CaptureProcess(console, tableInitializer,totalTrafficUsedLabel);
